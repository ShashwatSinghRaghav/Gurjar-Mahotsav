  ...
  e.JQPlugin.createPlugin({
    ...
    _optionsChanged: function (t, i, n) {
      ...
      e.extend(i.options, n),
        this._adjustSettings(t, i, null != n.until || null != n.since || s);
      var o = new Date();
    ...
    _generateHTML: function (t) {
      ...
      for (
        ...
        (n |= "?" == t._show[r] && t._periods[r] > 0),
          (a[r] = "?" != t._show[r] || n ? t._show[r] : null),
          (s += a[r] ? 1 : 0),
      ...
      var _ = t.options.compact ? t.options.compactLabels : t.options.labels,
        ...
        u = function (e) {
          ...
          return a[e]
            ? i._translateDigits(t, t._periods[e]) + (n ? n[e] : _[e]) + " "
            : "";
        },
    ...
    _buildLayout: function (t, i, n, s, o, a) {
      for (
        var r = t.options[s ? "compactLabels" : "labels"],
          l = t.options.whichLabels || this._normalLabels,
          _ = function (e) {
            return (t.options[
              (s ? "compactLabels" : "labels") + l(t._periods[e])
            ] || r)[e];
          },
          p = function (e, i) {
    ...
    _calculatePeriods: function (e, t, i, n) {
      ...
      e._since
        ? n.getTime() < e._since.getTime()
          ? (e._now = n = s)
          : (n = e._since)
        : (s.setTime(e._until.getTime()),
          n.getTime() > e._until.getTime() && (e._now = n = s));
      var o = [0, 0, 0, 0, 0, 0, 0];
      if (t[0] || t[1]) {
